...
rule individual_stats:
	...
	shell:
		"plink --bfile {params.inprefix} --cow --missing --keep-snp-order --out {params.oprefix}" #python bin/individual_call_rate_visualization.py"
...
rule filter_individuals:
	...
	shell:
		"plink --bfile {params.inprefix} --cow --mind .1 --keep-snp-order --make-bed --out {params.oprefix}; python bin/individual_filtered_log_parsing.py {output.log} {input.csv}"
...
rule hwe_stats:
	...
	shell:
		"plink --bfile {params.inprefix}  --keep-snp-order --cow --nonfounders --hardy --out {params.oprefix}"
...
rule filter_hwe_variants:
	...
	shell:
		"plink --bfile {params.inprefix} --cow --nonfounders  --keep-snp-order --hwe 0.00000001 --make-bed --out {params.oprefix}; python bin/hwe_log_parsing.py {output.log} {input.csv}"
...
rule impute_sex:
	...
	shell:
		"plink --bfile {params.inprefix} --cow --impute-sex ycount --make-bed --out {params.oprefix}; python bin/missexed_animals_filter.py {output.sexcheck} {output.txt}; python bin/missexed_animals_filter_logging.py {output.txt} {output.log} {input.csv}" #{params.logprefix}.csv"
...
rule split_chromosomes:
	...
	shell:
		"for chr in $(seq 1 30); do plink --bfile {params.inprefix}  --keep-snp-order --chr $chr --make-bed  --nonfounders --cow --out {params.oprefix}$chr; done"
